...
$data = http_request("http://localhost/PWAAPI/api/main.php/edit/" . $_GET['id']);
    ...
    <div id="wrapper">
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                <p class="text-primary m-0 fw-bold">Edit Barang</p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
            <form action="/api/main.php/edit/<?php echo $_GET['id'] ?>" method="post" enctype="application/x-www-form-urlencoded">
                    <div class="p-5">
                        <div class="mb-3">
